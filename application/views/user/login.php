...
<body>
	...
	<div class="login-card">
		...
		<?php if ($CI->session->userdata('msg_failed')) { ?>
			<div class="alert-danger">
				<i class="fas fa-circle-exclamation"></i>
				<?php echo $CI->session->userdata('msg_failed');
				$CI->session->unset_userdata('msg_failed'); ?>
			</div>
		<?php } ?>

		<?php if ($CI->session->userdata('msg_block')) { ?>
			<div class="alert-block">
				<i class="fas fa-ban"></i>
				<?php echo $CI->session->userdata('msg_block');
				$CI->session->unset_userdata('msg_block'); ?>
			</div>
		<?php } ?>
